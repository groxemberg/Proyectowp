    ...
    <div class="x_title text-center">
      ...
      <div class="row">
        <div class="col-md-2">
          ...
          <select name="tipoInforme" id="tipoInforme" class="col-md-12 form-control" value="<?php echo set_value('tipoInforme'); ?>" autocomplete="off" >
        ...
        <div class="col-md-2">
          ...
          <input type="text" name="nroInforme" id="nroInforme" placeholder="" class="col-md-12 form-control" autocomplete="off" ><br>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <input type="date" name="fechaPresentacion" class="col-md-12 form-control" placeholder="Ingrese la fecha de conclusión" autocomplete="off"> <br>
        </div>
